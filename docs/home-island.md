...
| 테마명 | SW 원본 | 해금(대략) | 역할 |
|--------|---------|------------|------|
| 서머너 탑 | Summoner's Tower | 시작 | 방어덱·기록·각성재료 |
...
**Phase 1 수치 스텁 (진액 연못):**  
- 생산: 약 441/hr, 저장 상한 약 4000 (SW Pond of Mana급 — 구현 시 Spokland로 확정)
...
1. **소환진** — 소환 UI 입구  
2. **강화진** — 레벨업 + 진화(최대 E2, Lv10/15 게이트, 마나·크리스탈)  
3. **출정문** — 시나리오 1챕터  
4. **진액 연못** — 마나 시간 생산·수집  
