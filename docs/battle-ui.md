...
flowchart TB
  TopHUD[상단_알림_스테이지]
  Enemy[적_진영_서머너중앙_몬스터4]
  Board[중앙_마법진_바둑판]
  Skills[스킬_아이콘]
  Ally[아군_진영_서머너중앙_몬스터4]
...
| 영역 | 역할 |
|------|------|
| 상단 적 진영 | 적 서머너(중앙) + 몬스터 4. HP(녹)/ATB(청)/버프 |
| 중앙 마법진 | 공유 보드(**5×5 / 7×7 / 9×9**) + 마법 아우라. 화면 높이 ~18–28% (크기별) |
| 하단 아군 진영 | 아군 서머너(중앙) + 몬스터 4 |
| 스킬 3칸 | 행동 유닛 스킬. 마나 풀 시 서머너기 강조 |
...
### 반자동
- AI가 착수 후보 **3점** + 예상 Amplify·마나 획득 미리보기
- 플레이어가 점 선택 후 스킬은 수동/자동
