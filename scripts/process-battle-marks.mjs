/**
 * Dematte painted board-mark PNGs → WebP.
 * Input: apps/web/public/art/battle/mark/_src/{id}.png
 * Output: apps/web/public/art/battle/mark/{id}.webp
 *
 * Usage: node scripts/process-battle-marks.mjs [srcDir]
 */
...
const outDir = path.join(root, "apps/web/public/art/battle/mark");
