/**
 * Dematte painted stone PNGs → WebP.
 * Input: apps/web/public/art/battle/stone/_src/{id}.png
 * Output: apps/web/public/art/battle/stone/{id}.webp
 *
 * Usage: node scripts/process-battle-stones.mjs [srcDir]
 */
...
const outDir = path.join(root, "apps/web/public/art/battle/stone");
...
console.log("processed", n, "stones");
